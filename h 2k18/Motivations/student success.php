...
body {
 font-family: 'Merienda';font-size: 20px;
      ...
      <a href="#" class="brand-logo center" style="display: inline;">Student Success</a>
        ...
        <div class="col s12 m6 l4">
          <div class="card">
            <div class="card-image">
              <img src="../Motivations/images/6.Student Success/1.jpg">
            <br>
              <img src="../Motivations/images/6.Student Success/2.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/3.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/4.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/5.png">
              <br>
               <img src="../Motivations/images/6.Student Success/6.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/7.jpeg">
              <br>
               <img src="../Motivations/images/6.Student Success/8.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/9.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/10.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/11.jpg">
              <br>
               <img src="../Motivations/images/6.Student Success/12.jpg">
                <br>
               <img src="../Motivations/images/6.Student Success/13.jpg">
                <br>
               <img src="../Motivations/images/6.Student Success/14.jpeg">
                 <br>
               <img src="../Motivations/images/6.Student Success/15.jpg">
