...
body {
 font-family: 'Merienda';font-size: 20px;
      ...
      <a href="#" class="brand-logo center" style="display: inline;">Life Leasson</a>
        ...
        <div class="col s12 m6 l4">
          <div class="card">
            <div class="card-image">
              <img src="../Motivations/images/8.Life Lesson/1.jpg">
            <br>
              <img src="../Motivations/images/8.Life Lesson/2.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/3.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/4.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/5.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/6.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/7.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/8.png">
              
              <br>
               <img src="../Motivations/images/8.Life Lesson/10.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/11.jpg">
              <br>
               <img src="../Motivations/images/8.Life Lesson/12.jpg">
