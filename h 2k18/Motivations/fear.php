...
body {
 font-family: 'Merienda';font-size: 20px;
      ...
      <a href="#" class="brand-logo center" style="display: inline;">Fear</a>
        ...
        <div class="col s12 m6 l4">
          <div class="card">
            <div class="card-image">
              <img src="../Motivations/images/12.Fear/1.jpg">
            <br>
              <img src="../Motivations/images/12.Fear/2.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/3.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/4.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/5.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/6.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/7.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/8.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/9.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/10.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/11.jpg">
              <br>
               <img src="../Motivations/images/12.Fear/12.png">
                <br>
               <img src="../Motivations/images/12.Fear/13.jpg">
