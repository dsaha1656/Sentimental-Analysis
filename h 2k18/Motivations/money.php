...
body {
 font-family: 'Merienda';font-size: 20px;
      ...
      <a href="#" class="brand-logo center" style="display: inline;">Money</a>
        ...
        <div class="col s12 m6 l4">
          <div class="card">
            <div class="card-image">
              <img src="../Motivations/images/15.Money/1.jpg">
            <br>
              <img src="../Motivations/images/15.Money/2.jpg">
              <br>
               <img src="../Motivations/images/15.Money/3.jpg">
              <br>
               <img src="../Motivations/images/15.Money/4.jpg">
              <br>
               <img src="../Motivations/images/15.Money/5.jpg">
              <br>
               <img src="../Motivations/images/15.Money/6.jpg">
              <br>
               <img src="../Motivations/images/15.Money/7.png">
              <br>
               <img src="../Motivations/images/15.Money/8.jpg">
