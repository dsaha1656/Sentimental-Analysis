...
body {
 font-family: 'Merienda';font-size: 20px;
      ...
      <a href="#" class="brand-logo center" style="display: inline;">Relationship</a>
        ...
        <div class="col s12 m6 l4">
          <div class="card">
            <div class="card-image">
              <img src="../Motivations/images/10.Relationship/1.jpg">
            <br>
              <img src="../Motivations/images/10.Relationship/2.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/3.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/4.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/5.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/6.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/7.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/8.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/9.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/10.jpeg">
              <br>
               <img src="../Motivations/images/10.Relationship/11.jpg">
              <br>
               <img src="../Motivations/images/10.Relationship/12.jpg">
                <br>
               <img src="../Motivations/images/10.Relationship/13.jpeg">
