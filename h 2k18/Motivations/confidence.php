...
body {
 font-family: 'Merienda';font-size: 20px;
      ...
      <a href="#" class="brand-logo center" style="display: inline;">Confidence</a>
        ...
        <div class="col s12 m6 l4">
          <div class="card">
            <div class="card-image">
              <img src="../Motivations/images/5.Confidence/1.jpg">
            <br>
              <img src="../Motivations/images/5.Confidence/2.jpg">
              <br>
               <img src="../Motivations/images/5.Confidencee/3.jpg">
              <br>
               <img src="../Motivations/images/5.Confidence/4.jpg">
              <br>
               <img src="../Motivations/images/5.Confidence/5.jpg">
              <br>
               <img src="../Motivations/images/5.Confidence/6.jpg">
              <br>
               <img src="../Motivations/images/5.Confidence/7.jpg">
              <br>
               <img src="../Motivations/images/5.Confidence/8.jpg">
              <br>
               <img src="../Motivations/images/5.Confidence/9.jpg">
              <br>
               <img src="../Motivations/images/5.Confidence/10.png">
              <br>
               <img src="../Motivations/images/5.Confidence/11.jpg">
