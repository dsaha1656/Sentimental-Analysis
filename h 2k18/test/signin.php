 ...
 */
const CLIENT_ID = '805788809733-tnicv7oe3tqf6hfesl1evsicrcgjq3l8.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = 'bT5GcG1wKR6AprwEl7SCk0zj';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "MindScript : The Teast of Mind";
