...
if (!empty($_POST['proof'])) {
  ...
  $to = $_POST['proof'];
  $subject = "MindScript Parent add Request";
  $body = "Hi,\n\nYour MindScript request code is : ".$_SESSION['authorize']."";
...
<header>
	...
	<nav class="deep-purple">
		<div class="nav-wrapper">
			...
			<a href="#" class="brand-logo center" style="display: inline;"> Invite Parent</a>
...
<main>
    ...
    <div class="row">
      <form id="formNode" action="add.php" method="POST" >
              <label for="1">Parent Email Address</label>
              <input type="text" isReq="true" type="email" name="proof" accept="image/*" id="1"/>
